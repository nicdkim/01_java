...
public class Application {
    public static void main(String[] args) {
        ...
        * 응답하는 상호작용을 설계하는 것이다.
        * 따라서 객체를 설계할 때는 속성은 부가적이며 적절한 책임을 가짖 객체들간데
        * 주고 받는 메세지를 이용해 상호작용하는 것을 설계하는 것을 의미한다
        * 즉, 필드보다는 메소드를 이중점으로 추상화 기법을 적용하여 객체를 설계하고
        ...
        *
        * 2. 객체간 상호작용
        * - 카레이서가 수신할 수 있는 메세지 (ㅋ레이서가 해야 하는 일)
        * 1. 시동을 걸어라
        * 2. 액셀을 밟아라
        * 3. 브레이크를 밟아라
        * 4. 시동을 꺼라
